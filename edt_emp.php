...
<?php include_once 'operations/edt_emp_op.php'; ?>
<!DOCTYPE html>
                                ...
                                <form class="p-4" action="" method="POST" enctype="multipart/form-data" name="from_employee" onsubmit="return validateForm()">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" name="first_name" value="<?php echo $emp_data['first_name'] ?>" id="first_name">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="last_name">Last Name</label>
                                                <input class="form-control" type="text" name="last_name" value="<?php echo $emp_data['last_name'] ?>" id="last_name">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mt-2">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="email" name="emp_email" value="<?php echo $emp_data['email'] ?>" id="emp_email">
                                            </div>
                                        </div>
                                        <div class="col-md-12 mt-2">
                                            <div class="mb-3">
                                                <label for="emp_mobile">Emp Mobile</label>
                                                <input class="form-control" type="number" name="emp_mobile" value="<?php echo $emp_data['mobile'] ?>" id="emp_mobile">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 text-end">
                                            <button type="submit" name="update_emp"  class="btn btn-success px-4">Update Employee</button>
                                        </div>
                                    </div>
                                </form>
                            </div><!--end card-->
